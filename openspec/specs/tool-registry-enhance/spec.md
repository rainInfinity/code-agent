# tool-registry-enhance Specification

## ADDED Requirements

### Requirement: DenyRule — 工具禁用规则
...
### Requirement: set_deny_rules — 设置禁用规则
...
### Requirement: get_enabled_tools — 获取已启用的工具
...
### Requirement: assemble_tool_pool — 组装完整工具池
